...
class VideoProcessor:
    ...
    def __init__(self, config: Dict[str, Any], frame_queue=None, stats_callback=None):
        self.cfg = config
    ...
    def process(self) -> None:
        ...
        while cap.more():
            ...
            # Enforce native video FPS pacing
            if fps > 0:
                elapsed_target = timestamp
            ...
            if self.stats_callback:
                ...
                self.stats_callback({
                    "motorcycles": mc_count,
                    "persons": person_count,
                    "available_gaps": available_gaps,
            ...
            if self.frame_queue is not None:
                # If queue is full, drop the oldest frame to avoid blocking the producer
